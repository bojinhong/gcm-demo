...
public class SendMessageServlet extends BaseServlet {
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    sender = new Sender("AIzaSyAIC8mYOnQAmajhQM0jfpaIcvOCvIKeeCo");
  }
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (regId != null) {
      sendSingleMessage(regId, resp, msgContent);
      return;
    }
    String multicastKey = req.getParameter(PARAMETER_MULTICAST);
    if (multicastKey != null) {
      sendMulticastMessage(multicastKey, resp, msgContent);
      return;
    }
  ...
  private void sendSingleMessage(String regId, HttpServletResponse resp,String content) {
  ...
  private void sendMulticastMessage(String multicastKey,
      HttpServletResponse resp, String content) {
